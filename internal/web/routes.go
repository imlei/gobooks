...
func (s *Server) registerRoutes(app *fiber.App) {
	...
	app.Get("/api/tasks/export", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskView), s.handleTasksExportCSV)
