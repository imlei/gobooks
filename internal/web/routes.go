...
func (s *Server) registerRoutes(app *fiber.App) {
	...
	app.Get("/version", s.handleVersion)
	...
	app.Get("/settings/channels/mappings", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleChannelMappings)
	...
	app.Get("/settings/channels/orders", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleChannelOrders)
	...
	app.Get("/settings/channels/orders/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleChannelOrderDetail)
	...
	app.Get("/settings/channels/accounting", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleAccountingMappings)
	...
	app.Get("/settings/channels/settlements", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleSettlements)
	...
	app.Get("/settings/channels/settlements/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleSettlementDetail)
	...
	// ── 设置：支付网关 ──────────────────────────────────────────────────────────
	app.Get("/settings/payment-gateways", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentGatewaysHub)
	app.Get("/settings/payment-gateways/processors", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentGateways)
	...
	app.Get("/settings/payment-gateways/mappings", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentMappings)
	...
	app.Get("/settings/payment-gateways/requests", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentRequests)
	...
	app.Get("/settings/payment-gateways/transactions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentTransactions)
	...
	app.Get("/settings/payment-gateways/transactions/:id/allocate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentMultiAllocateForm)
	...
	app.Get("/settings/payment-gateways/disputes", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewayDisputeList)
	app.Get("/settings/payment-gateways/disputes/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewayDisputeNew)
	...
	app.Get("/settings/payment-gateways/disputes/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewayDisputeDetail)
	...
	app.Get("/settings/templates", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePDFTemplatesList)

	// ── 设置：AR/AP Control Accounts ──────────────────────────────────────────
	app.Get("/settings/ar-ap-control", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleARAPControlGet)
	app.Post("/settings/ar-ap-control", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsUpdate), s.handleARAPControlCreate)
	app.Post("/settings/ar-ap-control/seed", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsUpdate), s.handleARAPControlSeedDefaults)
	app.Post("/settings/ar-ap-control/:id/delete", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsUpdate), s.handleARAPControlDelete)

	// ── 设置：AI Connect（owner / admin 专属）───────────────────────────────────
	app.Get("/settings/ai-connect", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleAIConnectGet)
	...
	app.Get("/accounts", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionAccountView), s.handleAccounts)
	...
	app.Post("/accounts/suggestions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionAccountView), s.handleAccountSuggestions)
	app.Post("/api/ai/recommend/account", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionAccountView), s.handleAIRecommendAccount)
	app.Post("/api/accounts/recommendations", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionAccountView), s.handleAccountRecommendations)
	...
	app.Get("/api/dashboard/overview", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.handleDashboardOverview)
	app.Get("/api/sales-transactions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleSalesTransactionsAPI)
	...
	app.Post("/api/report-usage", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleReportUsage)
	app.Post("/api/dashboard/suggestions/run", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleDashboardSuggestionsRun)
	app.Get("/api/dashboard/suggestions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleDashboardSuggestionsList)
	app.Post("/api/dashboard/suggestions/:id/accept", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleDashboardSuggestionAccept)
	app.Post("/api/dashboard/suggestions/:id/dismiss", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleDashboardSuggestionDismiss)
	app.Post("/api/dashboard/suggestions/:id/snooze", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleDashboardSuggestionSnooze)
	...
	app.Get("/journal-entry/list", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionJournalView), s.handleJournalEntryList)
	...
	app.Get("/journal-entry/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionJournalView), s.handleJournalEntryDetail)
	...
	app.Get("/invoices", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleInvoices)
	...
	app.Get("/invoices/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleInvoiceDetail)
	...
	// Invoice preview & PDF
	app.Get("/invoices/:id/preview", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleInvoicePreview)
	app.Get("/invoices/:id/print", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleInvoicePrint)
	app.Get("/invoices/:id/pdf", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleInvoicePDF)
	...
	app.Get("/invoices/:id/pdf-v2", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleInvoicePDFV2)
	app.Get("/quotes/:id/pdf-v2", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleQuotePDFV2)
	app.Get("/sales-orders/:id/pdf-v2", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleSalesOrderPDFV2)
	app.Get("/bills/:id/pdf-v2", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleBillPDFV2)
	app.Get("/purchase-orders/:id/pdf-v2", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handlePurchaseOrderPDFV2)
	app.Get("/shipments/:id/pdf-v2", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleShipmentPDFV2)
	...
	app.Get("/pdf-templates", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePDFTemplatesList)
	app.Get("/pdf-templates/:id/preview", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePDFTemplatePreview)
	...
	app.Get("/pdf-templates/:id/edit", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePDFTemplateEdit)
	...
	app.Post("/pdf-templates/preview-html", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePDFTemplatePreviewHTML)
	...
	app.Get("/api/invoices/:id/send-defaults", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleGetInvoiceSendDefaults)
	app.Get("/api/invoices/:id/email-preview", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleGetInvoiceEmailPreview)
	...
	app.Get("/credit-notes", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleCreditNotesList)
	...
	app.Get("/credit-notes/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleCreditNoteDetail)
	...
	app.Get("/ar-return-receipts", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleARReturnReceiptsList)
	...
	app.Get("/ar-return-receipts/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleARReturnReceiptDetail)
	...
	app.Get("/vendor-return-shipments", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVRSList)
	app.Get("/vendor-return-shipments/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVRSNewGet)
	app.Post("/vendor-return-shipments/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVRSSave)
	app.Get("/vendor-return-shipments/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVRSDetail)
	app.Post("/vendor-return-shipments/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVRSPostAction)
	app.Post("/vendor-return-shipments/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVRSVoidAction)
	app.Post("/vendor-return-shipments/:id/delete", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVRSDeleteAction)

	// AR Phase 2: Quotes + SalesOrders (real handlers)
	// Quotes
	app.Get("/quotes", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleQuotes)
	app.Get("/quotes/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleQuoteNew)
	app.Post("/quotes/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleQuoteSave)
	app.Get("/quotes/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleQuoteDetail)
	app.Post("/quotes/:id/send", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleQuoteSend)
	app.Post("/quotes/:id/accept", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleQuoteAccept)
	app.Post("/quotes/:id/reject", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleQuoteReject)
	app.Post("/quotes/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleQuoteCancel)
	app.Post("/quotes/:id/convert", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleQuoteConvert)
	// Sales Orders
	app.Get("/sales-orders", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleSalesOrders)
	app.Get("/sales-orders/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleSalesOrderNew)
	app.Post("/sales-orders/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleSalesOrderSave)
	app.Get("/sales-orders/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleSalesOrderDetail)
	app.Post("/sales-orders/:id/confirm", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleSalesOrderConfirm)
	app.Post("/sales-orders/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleSalesOrderCancel)
	...
	app.Get("/deposits", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleDeposits)
	app.Get("/deposits/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleDepositNew)
	app.Post("/deposits/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleDepositSave)
	app.Get("/deposits/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleDepositDetail)
	app.Post("/deposits/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleDepositPost)
	app.Post("/deposits/:id/apply", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleDepositApply)
	app.Post("/deposits/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleDepositVoid)
	...
	app.Get("/sales-transactions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleSalesTransactions)

	// Customer Receipts (Phase 4)
	app.Get("/receipts", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleReceipts)
	app.Get("/receipts/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleReceiptNew)
	app.Post("/receipts/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleReceiptSave)
	app.Get("/receipts/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleReceiptDetail)
	app.Post("/receipts/:id/confirm", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleReceiptConfirm)
	app.Post("/receipts/:id/apply", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleReceiptApply)
	app.Post("/receipts/:id/unapply", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleReceiptUnapply)
	app.Post("/receipts/:id/reverse", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleReceiptReverse)
	app.Post("/receipts/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleReceiptVoid)
	// Returns (Phase 5)
	app.Get("/returns", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleReturnList)
	app.Get("/returns/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleReturnNew)
	app.Post("/returns/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleReturnCreate)
	app.Get("/returns/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleReturnDetail)
	app.Post("/returns/:id/submit", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleReturnSubmit)
	app.Post("/returns/:id/approve", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleReturnApprove)
	app.Post("/returns/:id/reject", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleReturnReject)
	app.Post("/returns/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleReturnCancel)
	app.Post("/returns/:id/process", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleReturnProcess)
	// Refunds (Phase 5)
	app.Get("/refunds", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleRefundList)
	app.Get("/refunds/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleRefundNew)
	app.Post("/refunds/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleRefundCreate)
	app.Get("/refunds/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleRefundDetail)
	app.Post("/refunds/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleRefundPost)
	app.Post("/refunds/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleRefundVoid)
	app.Post("/refunds/:id/reverse", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleRefundReverse)
	// Write-Offs (Phase 6)
	app.Get("/write-offs", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleWriteOffList)
	app.Get("/write-offs/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleWriteOffNew)
	app.Post("/write-offs/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleWriteOffSave)
	app.Get("/write-offs/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleWriteOffDetail)
	app.Post("/write-offs/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleWriteOffPost)
	app.Post("/write-offs/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleWriteOffVoid)
	app.Post("/write-offs/:id/reverse", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceApprove), s.handleWriteOffReverse)
	// Customer Statement (Phase 6)
	app.Get("/customer-statement", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleCustomerStatement)

	// AP Phase A: Purchase Orders
	app.Get("/purchase-orders", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handlePurchaseOrderList)
	app.Get("/purchase-orders/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handlePurchaseOrderNew)
	app.Post("/purchase-orders/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handlePurchaseOrderSave)
	app.Get("/purchase-orders/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handlePurchaseOrderDetail)
	app.Post("/purchase-orders/:id/confirm", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handlePurchaseOrderConfirm)
	app.Post("/purchase-orders/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handlePurchaseOrderCancel)
	app.Post("/purchase-orders/:id/mark-received", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handlePurchaseOrderMarkReceived)
	app.Post("/purchase-orders/:id/close", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handlePurchaseOrderClose)

	// AP Phase A: Vendor Prepayments
	app.Get("/vendor-prepayments", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorPrepaymentList)
	app.Get("/vendor-prepayments/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorPrepaymentNew)
	app.Post("/vendor-prepayments/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorPrepaymentSave)
	app.Get("/vendor-prepayments/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorPrepaymentDetail)
	app.Post("/vendor-prepayments/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorPrepaymentPost)
	app.Post("/vendor-prepayments/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorPrepaymentVoid)

	// AP Phase A: Vendor Returns
	app.Get("/vendor-returns", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorReturnList)
	app.Get("/vendor-returns/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorReturnNew)
	app.Post("/vendor-returns/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorReturnSave)
	app.Get("/vendor-returns/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorReturnDetail)
	app.Post("/vendor-returns/:id/submit", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorReturnSubmit)
	app.Post("/vendor-returns/:id/approve", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorReturnApprove)
	app.Post("/vendor-returns/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorReturnCancel)
	app.Post("/vendor-returns/:id/process", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorReturnProcess)

	// AP Phase A: Vendor Credit Notes
	app.Get("/vendor-credit-notes", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorCreditNoteList)
	app.Get("/vendor-credit-notes/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorCreditNoteNew)
	app.Post("/vendor-credit-notes/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorCreditNoteSave)
	app.Get("/vendor-credit-notes/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorCreditNoteDetail)
	app.Post("/vendor-credit-notes/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorCreditNotePost)
	app.Post("/vendor-credit-notes/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorCreditNoteVoid)
	app.Post("/vendor-credit-notes/:id/apply-to-bill", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillPay), s.handleVCNApplyToBill)
	app.Post("/vendor-credit-notes/applications/:id/remove", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillPay), s.handleVCNRemoveApplication)

	// AP Phase A: Vendor Refunds
	app.Get("/vendor-refunds", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorRefundList)
	app.Get("/vendor-refunds/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorRefundNew)
	app.Post("/vendor-refunds/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorRefundSave)
	app.Get("/vendor-refunds/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorRefundDetail)
	app.Post("/vendor-refunds/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorRefundPost)
	app.Post("/vendor-refunds/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorRefundVoid)
	app.Post("/vendor-refunds/:id/reverse", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillUpdate), s.handleVendorRefundReverse)
	...
	app.Get("/inventory/stock", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryView), s.handleInventoryStock)
	app.Get("/inventory/transfers", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryView), s.handleTransferList)
	app.Get("/inventory/transfers/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryCreate), s.handleTransferNew)
	app.Post("/inventory/transfers/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryCreate), s.handleTransferCreate)
	app.Get("/inventory/transfers/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryView), s.handleTransferDetail)
	app.Post("/inventory/transfers/:id/save", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryUpdate), s.handleTransferUpdate)
	app.Post("/inventory/transfers/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryPost), s.handleTransferPost)
	app.Post("/inventory/transfers/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryUpdate), s.handleTransferCancel)

	// Batch 13: settlement review list + row-level retry
	app.Get("/settings/payment-gateways/settlement-review", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewaySettlementReview)
	...
	app.Get("/settings/payment-gateways/payouts", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewayPayoutList)
	app.Get("/settings/payment-gateways/payouts/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewayPayoutNew)
	...
	app.Get("/settings/payment-gateways/payouts/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleGatewayPayoutDetail)
	// Batch 18: Payout ↔ bank entry reconciliation — /reconcile must be before /:id
	app.Get("/settings/payment-gateways/payout-reconciliation", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePayoutReconciliationOverview)
	...
	app.Get("/settings/payment-gateways/payouts/:id/reconcile", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePayoutMatchForm)
	...
	app.Get("/settings/payment-gateways/reconciliation-exceptions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleReconciliationExceptionList)
	app.Get("/settings/payment-gateways/reconciliation-exceptions/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleReconciliationExceptionNew)
	...
	app.Get("/settings/payment-gateways/reconciliation-exceptions/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleReconciliationExceptionDetail)
	...
	app.Get("/settings/payment-gateways/reverse-exceptions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentReverseExceptionList)
	app.Get("/settings/payment-gateways/reverse-exceptions/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handlePaymentReverseExceptionDetail)
	...
	app.Get("/settings/payment-gateways/investigation", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionSettingsSensitiveView), s.handleInvestigationWorkspace)
	...
	app.Get("/bills", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleBills)
	...
	app.Get("/bills/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleBillDetail)
	...
	app.Get("/api/reports/trial-balance", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleTrialBalanceAPI)
	...
	app.Get("/api/reports/income-statement", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleIncomeStatementAPI)
	app.Get("/reports/income-statement/export.csv", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleExportIncomeStatementCSV)
	...
	app.Get("/api/reports/balance-sheet", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleBalanceSheetAPI)
	app.Get("/reports/balance-sheet/export.csv", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleExportBalanceSheetCSV)
	app.Get("/reports/ar-aging", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleARAgingReport)
	app.Get("/reports/ar-aging/export.csv", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleExportARAgingCSV)
	...
	app.Get("/api/reports/journal-entries", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleJournalEntryReportAPI)
	app.Get("/reports/general-ledger", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleGeneralLedger)
	app.Get("/api/reports/general-ledger", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleGeneralLedgerAPI)
	app.Get("/reports/cash-flow", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleCashFlow)
	app.Get("/api/reports/cash-flow", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleCashFlowAPI)
	app.Get("/reports/sales-by-customer", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleSalesByCustomer)
	...
	app.Get("/api/reports/account-transactions", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionReportView), s.handleAccountTransactionsAPI)
	...
	app.Get("/products-services", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryView), s.handleProductServices)
	...
	app.Get("/products-services/:id/ledger", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInventoryView), s.handleInventoryLedger)
	...
	app.Get("/customers", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleCustomers)
	...
	app.Get("/customers/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleCustomerDetail)
	// Batch 16: customer credit balance
	app.Get("/customers/:id/credits", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceView), s.handleCustomerCredits)
	...
	app.Get("/customers/:id/credits/:creditID/allocate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceUpdate), s.handleCreditMultiAllocateForm)
	...
	app.Post("/customers/:id/update", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerDetailUpdate)
	// Migration 088: customer shipping-address catalogue (for ship-to selection on Invoice/SO/Shipment).
	app.Post("/customers/:id/shipping-addresses", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerShippingAddressCreate)
	app.Post("/customers/:id/shipping-addresses/:addrID/delete", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerShippingAddressDelete)
	app.Post("/customers/:id/shipping-addresses/:addrID/set-default", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerShippingAddressSetDefault)
	app.Post("/customers/:id/delete", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerDelete)
	app.Post("/customers/:id/deactivate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerDeactivate)
	app.Post("/customers/:id/reactivate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionInvoiceCreate), s.handleCustomerReactivate)
	app.Get("/tasks", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskView), s.handleTasks)
	app.Get("/tasks/billable-work", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskBill), s.RequirePermission(ActionInvoiceCreate), s.handleTaskBillableWork)
	app.Get("/tasks/billable-work/report", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskView), s.handleTaskBillableWorkReport)
	app.Post("/tasks/billable-work/generate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskBill), s.RequirePermission(ActionInvoiceCreate), s.handleTaskGenerateInvoiceDraft)
	app.Get("/tasks/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskCreate), s.handleTaskNew)
	app.Get("/tasks/monthly-report", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskView), s.handleTasksMonthlyReport)
	app.Post("/tasks", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskCreate), s.handleTaskCreate)
	app.Get("/tasks/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskView), s.handleTaskDetail)
	app.Get("/tasks/:id/edit", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskUpdate), s.handleTaskEdit)
	app.Post("/tasks/:id/edit", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskUpdate), s.handleTaskUpdate)
	app.Post("/tasks/:id/complete", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskUpdate), s.handleTaskComplete)
	app.Post("/tasks/:id/cancel", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskUpdate), s.handleTaskCancel)
	app.Get("/api/tasks/export", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyTask), s.RequirePermission(ActionTaskView), s.RequirePermission(ActionTaskExport), s.handleTasksExportCSV)
	app.Get("/employees", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyEmployee), s.RequirePermission(ActionEmployeeView), s.handleEmployees)
	app.Post("/employees", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyEmployee), s.RequirePermission(ActionEmployeeManage), s.handleEmployeeCreate)
	app.Get("/payroll/reports/summary", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionReportView), s.RequirePermission(ActionPayrollViewDetails), s.handlePayrollSummaryReport)
	app.Get("/payroll/reports/summary/export.csv", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionReportView), s.RequirePermission(ActionPayrollViewDetails), s.RequirePermission(ActionPayrollExport), s.handlePayrollSummaryExportCSV)
	app.Get("/payroll/reports/employee-history", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionReportView), s.RequirePermission(ActionPayrollViewDetails), s.handlePayrollEmployeeHistoryReport)
	app.Get("/payroll/reports/employee-history/export.csv", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionReportView), s.RequirePermission(ActionPayrollViewDetails), s.RequirePermission(ActionPayrollExport), s.handlePayrollEmployeeHistoryExportCSV)
	app.Get("/payroll/runs", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollView), s.handlePayrollRuns)
	app.Post("/payroll/runs", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollRun), s.handlePayrollRunCreate)
	app.Get("/payroll/remittances", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollViewDetails), s.handlePayrollRemittances)
	app.Post("/payroll/remittances/:id/pay", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollFinalize), s.handlePayrollRemittancePay)
	app.Post("/payroll/remittances/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollFinalize), s.handlePayrollRemittanceVoid)
	app.Get("/payroll/runs/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollView), s.handlePayrollRunDetail)
	app.Get("/payroll/runs/:id/export.csv", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollViewDetails), s.RequirePermission(ActionPayrollExport), s.handlePayrollRunExportCSV)
	app.Post("/payroll/runs/:id/calculate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollRun), s.handlePayrollRunCalculate)
	app.Post("/payroll/runs/:id/finalize", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollFinalize), s.handlePayrollRunFinalize)
	app.Post("/payroll/runs/:id/post", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollFinalize), s.handlePayrollRunPostJournal)
	app.Post("/payroll/runs/:id/remittance", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequirePermission(ActionPayrollFinalize), s.handlePayrollRunCreateRemittance)
	app.Post("/payroll/runs/:id/create-cheques", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyPayroll), s.RequireFeature(models.FeatureKeyCheque), s.RequirePermission(ActionPayrollViewDetails), s.RequirePermission(ActionChequePrint), s.handlePayrollRunCreateCheques)
	app.Get("/cheques", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyCheque), s.RequirePermission(ActionChequeView), s.handleCheques)
	app.Post("/cheques", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyCheque), s.RequirePermission(ActionChequePrint), s.handleChequeCreate)
	app.Post("/cheques/bank-accounts", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyCheque), s.RequirePermission(ActionChequeManageBank), s.handleChequeBankAccountCreate)
	app.Post("/cheques/:id/mark-printed", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyCheque), s.RequirePermission(ActionChequePrint), s.handleChequeMarkPrinted)
	app.Post("/cheques/:id/void", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequireFeature(models.FeatureKeyCheque), s.RequirePermission(ActionChequePrint), s.handleChequeVoid)
	app.Get("/expenses", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleExpenses)
	app.Get("/expenses/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleExpenseNew)
	...
	app.Get("/vendors", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendors)
	app.Get("/vendors/new", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorNew)
	...
	app.Get("/vendors/:id", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorDetail)
	...
	app.Post("/vendors/:id/delete", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorDelete)
	app.Post("/vendors/:id/deactivate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorDeactivate)
	app.Post("/vendors/:id/reactivate", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillCreate), s.handleVendorReactivate)
	app.Get("/vendors/:id/credits", s.LoadSession(), s.RequireAuth(), s.ResolveActiveCompany(), s.RequireMembership(), s.RequirePermission(ActionBillView), s.handleVendorCredits)
