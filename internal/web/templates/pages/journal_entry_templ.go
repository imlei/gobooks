...
func bodyJournalEntry(vm JournalEntryVM) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"max-w-[95%]\" x-data=\"gobooksJournalEntryDraft()\" x-init=\"init()\" data-company-id=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/journal_entry.templ`, Line: 16, Col: 121}
		}
		...
		if vm.FormError != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/journal_entry.templ`, Line: 33, Col: 18}
			}
		...
		for _, c := range vm.Customers {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/journal_entry.templ`, Line: 158, Col: 54}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/journal_entry.templ`, Line: 158, Col: 65}
			}
		...
		for _, v := range vm.Vendors {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/journal_entry.templ`, Line: 163, Col: 52}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/journal_entry.templ`, Line: 163, Col: 63}
			}
